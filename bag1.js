...
import ans_footer from "./Components/importfooter.js";
...
const emptyCartURL = "./emptyCart.html";
...
function createBagItemElement(item) {
  ...
  imgIconminus.setAttribute(
    "src",
    "https://www.svgrepo.com/show/146105/minus.svg"
  );
...
function calculateTotal() {
  ...
  pricePara.textContent = `Total (${cart.length} item${
    cart.length > 1 ? "s" : ""
  })`;
  ...
  anchorButton.setAttribute("href", "./razor.html");
